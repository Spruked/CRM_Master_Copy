...
rem Register the CURRENT client location at every manual launch. HKCU Run points
...
if errorlevel 1 (
  echo CALI CRM startup registration failed.
  exit /b 1
)

rem Start exactly one hidden tray supervisor. It owns the tray icon and ensures
